...
namespace AddInWebApp.Common
{
    ...
    public sealed partial class SqlHelper
    {
        ...
        public SqlHelper()
        {
            this.ConnectionString = ConfigurationManager.ConnectionStrings["connStr"].ConnectionString; //"Data Source =YUP-B-PC01\\SQL2008R2_YUP;Initial Catalog =DataAnalysis;User Id =sa;Password =123qwe!@#QWE;"; //ConfigurationManager.ConnectionStrings["connStr"].ConnectionString;
        }
        ...
        {
            IDataReader reader = this.ExecuteDataReader(sql);
            //实例化一个List<>泛型集合  
